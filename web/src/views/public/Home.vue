...
const features = [
  { title: '极速下发', desc: '智能路由策略确保毫秒级调度，批量任务保持稳定响应。' },
  { title: '安全可靠', desc: '多节点转发与访问隔离机制，适合长期稳定承载创作请求。' },
  { title: '简单易用', desc: '兼容标准接口结构，脚本、服务端与工作台均可快速接入。' },
]
  ...
  <div class="home-page">
    <section class="hero-section">
      <div class="hero-section__copy">
        ...
        <div class="hero-actions">
          ...
          <router-link to="/showcase" class="hero-action hero-action--ghost">查看案例库</router-link>
        </div>
    ...
    <section class="showcase-section section-shell">
      <div class="section-head">
        ...
        <router-link to="/showcase" class="section-link">浏览完整案例库</router-link>
      </div>
