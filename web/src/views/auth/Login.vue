    ...
    >
      ...
      <template #footer>
        <div class="auth-actions">
          <p v-if="allowRegister" class="auth-tip">首次使用可先注册账号并领取体验额度</p>
          <p v-else class="auth-tip auth-tip--muted">当前采用邀请开通方式，可联系管理员创建账号后登录控制台</p>
          <router-link v-if="allowRegister" to="/register" class="auth-link">注册账号</router-link>
        </div>
      </template>
    </AuthFormCard>
  </AuthShell>
